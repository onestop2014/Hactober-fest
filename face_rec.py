...
face_cascade = cv2.CascadeClassifier("F:/face/Python3/project/haarcascade_frontalface_default.xml")
...
model.load_weights('F:/face/Python3/project/weights/openface_weights.h5')
...
employee_pictures = "F:/face/Python3/project/data/"

employees = dict()

for file in listdir(employee_pictures):
	employee, extension = file.split(".")
	img = preprocess_image('F:/face/Python3/project/data/%s.jpg' % (employee))
...
while(True):
	...
	for (x,y,w,h) in faces:
		...
		if w > 130: #discard small detected faces
			...
			# cv2.imshow("Dec", detected_face)
			# cv2.waitKey(5)
			if count==1:
				cv2.imwrite("F:/face/Python3/project/temp_unknown/rup.png",detected_face)
